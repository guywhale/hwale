<div class="{{ $block->classes }} relative overflow-x-hidden">
  ...
  <div class="container">
    <div class="flex-col hidden w-full md:flex lg:flex-row">
      <div class="relative flex items-center justify-end w-full h-1/3-screen md:h-1/2-screen lg:h-screen lg:w-1/2 animate-slide-in-left lg:flex-row px-3.75 md:px-7.5 lg:pr-7.5 lg:pl-0 xl:pr-15">
