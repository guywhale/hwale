<{{ $type }}
  {{ $url }}
  class="button group relative inline-block min-w-35.5 min-h-11 border border-white transition-all bg-black-light shadow-0 hover:shadow-button-hover {{ $classes }}"
  {{ $target }}
>
