<{{ $type }}
  {{ $url }}
  class="group relative inline-block min-w-35.5 border border-white hover:border-red transition-all bg-black-light shadow-none hover:shadow-button-hover {{ $classes }}"
  {{ $target }}
>
